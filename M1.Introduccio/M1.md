...
Cal tenir en compte que es tracta d'un curs d'iniciació i és possible que vos sentiu aclaparats de tota la informació que aneu a veure, òbviament per la durada del curs no anem a poder aprofundir en molts de les utilitats que vos presentarem, això ha vos ho deixarem a vosaltres.

Els mòduls seran breus però intensos, tractarem d'ajudar-vos en tots els dubtes que se vos plantegen, però nosaltres també hem decidit fer ús de les diferents ferramentes d'IA per a fer el curs, sobre tot amb les imatges, en molts casos vos presentarem el prompt[^1] i la resposta que ens donarà, tractarem de limitar l'extensió al que realment necessiteu. Les respostes vos diem que estaran retocades ja que la resposta que dona sempre qualsevol plataforma sempre ha de retocar-se per a que siga el més idònia possible al que desitges. Vos ho presentarem amb la següent icona.
...
Aqui tens un exemple de diagrama de flux senzill:

<!-- DIAGRAMA FLUXE -->
![Diagrama de flux. Origen: Wikipedia](img/1.svg)
...
![Xarxa neuronal. Origen: Wikipedia](img/2.png)
...
![Imatge dibuixada per nosaltres](img/3.png){ width=10cm }

Al menú dalt la plataforma tractarà d'esbrinar què hem dibuixat i ens proporcionarà una imatge un tant millor dibuixada que el que hem fet.

![Imatge del menú escollida](img/4.png){ width=10cm }
...
![Joc](img/5.png){ width=10cm }

![Imatge a esbrinar](img/6.png){ width=10cm }

![El nostre dibuix](img/7.png){ width=10cm }

Així anirà fent durant 6 imatges. És un bon exercici per a entendre com funcionen les xarxes neuronals.

![Ens ha encertat els 6](img/8.png){ width=10cm }
