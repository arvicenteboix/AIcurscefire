...
# Cercadors que utilizen intel·ligència artifical
...
:::note
Es tracta d'una ferramenta de pagament com casi totes les que anem a veure, aquestes ens permeten crear una sèrie d'arxius multimèdia al dia. Així que cal tenir en compte aquestes limitacions. Flexclip, també altres ferramentes que poden resultar interessant com la generació d'imatges a banda de ser un editor de vídeo online.
:::
